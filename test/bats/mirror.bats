...
@test "NVH_NODE_MIRROR=https://npm.taobao.org/mirrors/node nvh install 6" {
  readonly TMP_PREFIX="$(mktemp -d)"

  NVH_PREFIX="${TMP_PREFIX}" NVH_NODE_MIRROR="https://npm.taobao.org/mirrors/node" nvh --insecure install 6
